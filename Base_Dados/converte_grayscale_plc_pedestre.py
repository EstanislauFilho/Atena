...
caminho_pasta_original = "/home/estanislau/Projetos/Atena/Base_Dados/pedestre/plc_pedestre_original/*.jpg"
caminho_pasta_destino = "/home/estanislau/Projetos/Atena/Base_Dados/pedestre/plc_pedestre/"
...
for i in sorted(glob.glob(caminho_pasta_original)):
    ...
    try:
        imagem_red = cv2.resize(imagem, (50,50))

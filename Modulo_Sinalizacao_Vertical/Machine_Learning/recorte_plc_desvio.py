...
caminho_pasta_original = "/home/estanislau/Projetos/Atena/Mistura/Machine_Learning/ori_plc_desvio/*.jpg"
caminho_pasta_destino = "/home/estanislau/Projetos/Atena/Mistura/Machine_Learning/rec_plc_desvio/"
...
for i in sorted(glob.glob(caminho_pasta_original)):
    ...
    try:
        ...
        imagem_red = cv2.resize(imagem_hsv, (60,30))
